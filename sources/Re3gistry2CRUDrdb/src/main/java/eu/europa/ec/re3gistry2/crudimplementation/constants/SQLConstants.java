...
public class SQLConstants {
    ...
    public static final String SQL_GET_REG_ITEM_BY_SUBJECT_PREDICATE_AND_FILTER_PREDICATE = "SELECT r0.regItemSubject FROM (SELECT * FROM RegRelation r JOIN RegItem ri on ri.uuid = r.regItemSubject WHERE ri.regStatus = :regStatus AND r.regItemObject = :regitem AND r.regRelationpredicate = :predicate) r0 WHERE r0.regItemSubject NOT IN (SELECT r1.regItemSubject FROM RegRelation r1 WHERE r1.regRelationpredicate = :notpredicate)";
...
// RegRelation
    ...
    public static final String SQL_GET_RELATIONHISTORYBY_SUBJECT_PREDICATE_AND_FILTER_PREDICATE = "SELECT r0.regItemSubject FROM (SELECT * FROM RegRelationhistory r JOIN RegItem ri on ri.uuid = r.regItemSubject WHERE ri.regStatus = :regStatus AND r.regItemObjectHistory = :regitem AND r.regRelationpredicate = :predicate) r0 WHERE r0.regItemSubject NOT IN (SELECT r1.regItemSubject FROM RegRelation r1 WHERE r1.regRelationpredicate = :notpredicate)";
