...
public interface IRegRelationproposedManager {

    public RegRelationproposed get(String uuid) throws Exception;

    public List<RegRelationproposed> getAll() throws Exception;

    public boolean add(RegRelationproposed i) throws Exception;

    public boolean update(RegRelationproposed i) throws Exception;

    public boolean delete(RegRelationproposed i) throws Exception;

    public List<RegRelationproposed> getAllBySubject(RegItemproposed r) throws Exception;

    public List<RegRelationproposed> getAllByObject(RegItemproposed regItemproposed) throws Exception;

    public List<RegRelationproposed> getAll(RegItemproposed regItem, RegRelationpredicate regRelationPredicate) throws Exception;
