...
public interface IRegActionManager {

    public RegAction get(String uuid) throws Exception;

    public List<RegAction> getAll() throws Exception;

    public boolean add(RegAction i) throws Exception;

    public boolean update(RegAction i) throws Exception;
    public boolean delete(RegAction i) throws Exception;
