...
public interface IRegItemclasstypeManager{
    ...
    public boolean add(RegItemclasstype i) throws Exception;
    public boolean update(RegItemclasstype i) throws Exception;
