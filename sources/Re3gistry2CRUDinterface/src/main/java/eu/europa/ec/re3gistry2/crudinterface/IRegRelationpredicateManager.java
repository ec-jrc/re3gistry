...
public interface IRegRelationpredicateManager{
    ...
    public boolean add(RegRelationpredicate i) throws Exception;
    public boolean update(RegRelationpredicate i) throws Exception;
