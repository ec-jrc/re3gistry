...
public interface IRegItemRegGroupRegRoleMappingManager{
    ...
    public boolean add(RegItemRegGroupRegRoleMapping i) throws Exception;
    public boolean update(RegItemRegGroupRegRoleMapping i) throws Exception;
