...
@Entity
@Table(name = "reg_relation")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "RegRelation.findAll", query = "SELECT r FROM RegRelation r")
    , @NamedQuery(name = "RegRelation.findByUuid", query = "SELECT r FROM RegRelation r WHERE r.uuid = :uuid")
    , @NamedQuery(name = "RegRelation.findByInsertdate", query = "SELECT r FROM RegRelation r WHERE r.insertdate = :insertdate")
    , @NamedQuery(name = "RegRelation.findByEditdate", query = "SELECT r FROM RegRelation r WHERE r.editdate = :editdate")})
public class RegRelation implements Serializable {
    ...
    @OneToMany(mappedBy = "regRelationReference")
    ...
    public RegRelation(String uuid, Date insertdate) {
        this.uuid = uuid;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RegRelation)) {
            return false;
        }
        RegRelation other = (RegRelation) object;
    ...
    public String toString() {
        return "eu.europa.ec.re3gistry2.model.RegRelation[ uuid=" + uuid + " ]";
    }
