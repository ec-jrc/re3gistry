...
public class RegLocalizationUuidHelper {
    
    private RegLocalizationUuidHelper(){
    }
    
    public static String getUuid(int fieldValueIndex, RegLanguagecode regLanguagecode, RegItem regItem, RegField regField) throws Exception{
        
        String[] params = new String[4];
        params[0] = (fieldValueIndex>=0)? Integer.toString(fieldValueIndex) : "";
        params[1] = (regLanguagecode!=null)? regLanguagecode.getUuid() : "";
        params[2] = (regItem!=null)? regItem.getUuid() : "";
        params[3] = (regField!=null)? regField.getUuid() : "";
        
        return UuidHelper.createUuid(params, RegLocalization.class);
    } 
