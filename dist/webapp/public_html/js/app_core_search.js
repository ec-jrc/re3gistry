...
// Element name constants
        ...
        const elementClassName_overlayLoader = 'overlay-loader';
// Key contants
...
// HTML snippet constants
        const htmlSnippet_facet = '<div class="ecl-u-mt-m ecl-form-group ecl-form-group--select"><label class="ecl-form-label" for="facet-{0}">{1}</label><div class="ecl-select__container ecl-select__container--m"><select id="facet-{0}" class="ecl-select">{2}</select></div></div>';
        ...
        const htmlSnippet_paginationUl = '<ul class="pagination">{0}</ul>';
        const htmlSnippet_paginationPrevious = '<li class="page-item ecl-pagination__item--previous"><a id="previous-page-link" aria-label="{0}" href="{1}" class="page-link ecl-link ecl-link--standalone ecl-link--icon ecl-link--icon-before"><span class="ecl-link__label">{2}</span></a></li>';
        const htmlSnippet_paginationNext = '<li class="page-item ecl-pagination__item--next"><a id="next-page-link" aria-label="{0}" href="{1}" class="page-link ecl-link ecl-link--standalone ecl-link--icon ecl-link--icon-after"><span class="ecl-link__label">{2}</span> </a></li>';
        const htmlSnippet_currentPage = '<li class="page-item active"><span class="page-link" aria-label="{1} {0}" aria-current="true">{0} <span class="sr-only">(current)</span></span></li>';
        const htmlSnippet_page = '<li class="page-item"><a aria-label="{0} {1}" href="{2}" class="page-link ecl-link ecl-link--standalone">{1}</a></li>';
        const htmlSnippet_paginationLi = '<li class="page-item">{0}</li>';
        const htmlSnippet_selectedFacetElement = '<span class="{0}"><span class="mr-2">{1}</span><button data-' + key_dataFacetParameter + '="{2}" data-role="tagsinput" class="ecl-u-ml-s ecl-tag ecl-tag--removable selected-facet-item btn btn-secondary btn-sm mr-3">{3} <i class="fas fa-times"></i></button></span>';
...
// ** Script body ** //
         ...
         */
                ...
                renderData(data, null, null, null);
                        ...
                        $('.' + elementClassName_overlayLoader).hide();
                        }
