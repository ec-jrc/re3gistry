...
<nav class="navbar navbar-expand-lg navbar-light sticky-top">
    ...
    <div class="collapse navbar-collapse openmenu">
            ...
            <c:choose>
                <c:when test="${not empty regUser}">
                    <li class="nav-item bg-hover-gray">
                        <a class="nav-link" title="View user details" href=".<%=WebConstants.PAGE_URINAME_USERPROFILE%>"><%=regUser.getName()%>&nbsp;<i class="fas fa-user"></i></a>
                    </li>
                    <li class="nav-item bg-hover-gray">
        ...
        <div class="d-md-none">						
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="${properties.get("web.link_about").toString().replace("__lng__",localization.getString("property.localeid"))}">${localization.getString("label.about")}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${properties.get("web.link_contact").toString().replace("__lng__",localization.getString("property.localeid"))}">${localization.getString("label.contact")}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${properties.get("web.link_privacy").toString()}">${localization.getString("label.privacy")}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${properties.get("web.link_legal").toString().replace("__lng__",localization.getString("property.localeid"))}">${localization.getString("label.legal")}</a>
                </li>
            </ul>
            <hr/>
