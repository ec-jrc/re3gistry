...
Rem AS WELL AS CUSTOM FILES WITH THE HEADER AND THE FOOTER, WITH ECL AND SHIRO(inpire_local) OR ECAS (inspire_server)
...
set "Re3gistry2ServiceWebapp=Re3gistry2ServiceWebapp\\public_html"
set "destiantionRe3gistry2ServiceWebapp=webapp\\public_html" 
robocopy %copyFROM%%Re3gistry2ServiceWebapp% %copyTOdistGithub%%destiantionRe3gistry2ServiceWebapp% *.html /S
