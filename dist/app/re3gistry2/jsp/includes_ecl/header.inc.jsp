    ...
    <div class="ecl-site-header__container ecl-container">
        <div class="ecl-site-header__banner"><a data-i18n-link="l-ec-website" class="ecl-link ecl-link--standalone" href="https://ec.europa.eu/info/index_en"
                                                aria-label="European Commission"><img alt="European Commission logo" title="European Commission"
                                                  class="ecl-site-header__logo-image" src="./res/ecl-v2/static/logo/logo--en.30b933cc.svg" /></a>
        ...
        <form class="ecl-site-header__search ecl-search-form" role="search" style="display: none">
            <div class="ecl-form-group ecl-form-group--text-input"><label class="ecl-search-form__label ecl-form-label"
                    ...
                    <use xlink:href="./res/ecl-v2/static/media/icons.svg#general--search"></use>
                    </svg></span></button>
        </form>
    </div>
</header>
...
<div class="ecl-page-header">
    <div class="ecl-container">
        <nav class="ecl-page-header__breadcrumb ecl-breadcrumb" aria-label="You are here:" data-ecl-breadcrumb="true">
            <ol class="ecl-breadcrumb__container">
                <li class="ecl-breadcrumb__segment" data-ecl-breadcrumb-item="static" aria-hidden="false">
                    ...
                    <use xlink:href="./res/ecl-v2/static/media/icons.svg#ui--corner-arrow"></use>
                    </svg>
                </li>
                <li class="ecl-breadcrumb__segment" data-ecl-breadcrumb-item="static" aria-hidden="false"><a href="//inspire.ec.europa.eu" data-i18n="s-inspire"
                                                                                                             class="ecl-breadcrumb__link ecl-link ecl-link--standalone">INSPIRE</a>
                    <!--                                                                                                             <svg
        ...
        <h1 class="ecl-page-header__title ecl-u-type-color-white" data-i18n="s-site-title">Re3gistry - ${localization.getString("label.subtitle")}</h1>
    </div>
