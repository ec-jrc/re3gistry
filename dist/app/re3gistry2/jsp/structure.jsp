                        ...
                        <td>
                            <ul>
                                <li>
                                    ...
                                    <a class="text-danger btn-approve-action btn-reg-action" data-toggle="confirmation" data-title="${localization.getString("discard.contentclass.confirm")}" data-placement="left" data-singleton="true" href=".<%=WebConstants.PAGE_URINAME_ITEMCLASS%>?<%=BaseConstants.KEY_REQUEST_ITEMCLASSUUID%>=<%=tmpRegItemclass.getUuid()%>&<%=BaseConstants.KEY_REQUEST_ACTION%>=<%=BaseConstants.KEY_REQUEST_REMOVE_VALUE_TYPE_REMOVE%>"><i class="far fa-trash-alt" title="${localization.getString("label.remove")}"></i></a>
                                </li>
                                <% } %>
                            </ul>
                        </td>
